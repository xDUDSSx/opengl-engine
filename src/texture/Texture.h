...
public:
	...
	/**
	 * \brief Bind the texture and activate texture unit for use with a specific shader.
	 * \param typeIndex Texture index of this texture type
	 * \param textureUnit The texture unit id
	 * \param shader Shader which will use the texture
	 */
